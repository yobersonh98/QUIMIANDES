...
INSERT INTO "Municipio" ("id", "nombre", "estado", "idDepartamento")
  VALUES
	('1','Abriaquí','1','5'),
	('2','Acacías','1','50'),
	('3','Acandí','1','27'),
  ...
  (gen_random_uuid(), 'Granel', NULL),
  (gen_random_uuid(), 'Galon', NULL),
  (gen_random_uuid(), 'Bolsa', NULL),
  (gen_random_uuid(), 'Caneca de 250 Kg', NULL),
  (gen_random_uuid(), 'Carrito', NULL),
  (gen_random_uuid(), 'Pimpina', NULL),
  (gen_random_uuid(), 'Equipo', NULL),
  (gen_random_uuid(), 'Litro', NULL),
  (gen_random_uuid(), 'Tambor', NULL),
  (gen_random_uuid(), 'Cilindro de Cloro', NULL),
  (gen_random_uuid(), 'Caja', NULL),
  (gen_random_uuid(), 'Unidad', NULL),
  (gen_random_uuid(), 'Gotero', NULL),
  (gen_random_uuid(), 'Paquete de 100 pruebas', NULL),
  (gen_random_uuid(), 'Gotero para 100 test', NULL),
  (gen_random_uuid(), 'Paquete de 300 pruebas', NULL),
  (gen_random_uuid(), 'Kit', NULL),
  (gen_random_uuid(), 'Mangera', NULL),
  (gen_random_uuid(), 'Manibomba', NULL),
  (gen_random_uuid(), 'Nasa', NULL),
  (gen_random_uuid(), 'Bulto', NULL),
  (gen_random_uuid(), 'Sobre', NULL),
  (gen_random_uuid(), 'Isotanque', NULL),
  (gen_random_uuid(), 'Gotero de 30ml', NULL),
  (gen_random_uuid(), '38 mm', NULL),
  (gen_random_uuid(), '53 mm', NULL),
  (gen_random_uuid(), '60 mm', NULL),
  (gen_random_uuid(), 'Tubo', NULL),
  (gen_random_uuid(), 'Caneca', NULL),
  (gen_random_uuid(), 'Rollo 1x L', NULL),
  (gen_random_uuid(), 'Rollo 1,45x L', NULL),
  (gen_random_uuid(), 'Empaque', NULL),
