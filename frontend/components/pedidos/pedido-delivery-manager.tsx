...
import PedidoInfoBasica from "./pedido-info-basica";
import { ProductsList } from "./products-list";
import { DeliveryHistory } from "./delivery-history";
import { cn, getBgColorByEstado } from "@/lib/utils";
      ...
      <Card className="overflow-hidden">
        <CardHeader className="p-3 sm:p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          ...
          <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto">
            {!noPuedeModificar && (
              <Link
                href={`/dashboard/pedidos/${pedido?.id}/gestionar/registrar-entrega`}
        ...
        <CardContent className="p-3 sm:p-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 mb-3">
            ...
            <DeliveryStatCard
              ...
              className={cn(
                ...
                getBgColorByEstado("ENTREGADO", 50)
              )}
              textColor={cn("text-green-600 dark:text-green-400")}
            />
            <DeliveryStatCard
              label="Parciales"
              ...
              className={cn(
                ...
                getBgColorByEstado("PARCIAL", 50)
              )}
              textColor={cn("text-blue-600 dark:text-blue-400")}
            />
            <DeliveryStatCard
              label="Pendientes"
              ...
              className={cn(
                ...
                getBgColorByEstado("PENDIENTE", 50)
              )}
              textColor={cn("text-yellow-600 dark:text-yellow-400")}
            />
          </div>
          ...
          <Alert className="mb-3 py-2 text-sm">
            ...
            <AlertDescription className="text-xs">
              El estado general del pedido se actualiza automáticamente según
